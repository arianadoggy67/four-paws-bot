...
def get_val(строка, ключ):
    """Ищет значение в словаре по ключу, игнорируя пробелы."""
...
def склонение_единиц(кол_во, единица):
    """Склоняет единицу измерения: 1 долька, 2 дольки, 5 долек."""
    ...
    if "ложка" in единица:
        if кол_во % 10 == 1 and кол_во % 100 != 11:
            ...
            return единица.replace("ка", "ки")
        else:
            return единица.replace("ка", "ек")
